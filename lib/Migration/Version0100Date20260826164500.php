...
#[CreateTable(
	...
	description: 'Persistent per-user scan index for MusicCurator audio files and MusicBrainz matches',
)]
class Version0100Date20260826164500 extends SimpleMigrationStep {
